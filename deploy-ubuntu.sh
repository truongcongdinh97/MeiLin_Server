...
echo "   Main API:      https://your-domain.com"
echo "   Telegram:      https://telegram-your-domain.com"
echo "   YouTube:       https://youtube-your-domain.com"
echo "   ChromaDB:      https://chroma-your-domain.com"
echo ""
