...
|----------|--------|---------|--------|
| **Kiến Trúc** | Python Backend + ESP32 Client | Full ESP32 C++ | MeiLin (linh hoạt hơn) |
...
XiaoZhi phù hợp cho: Quick hardware dự án, multi-platform triển khai, localized assistants.
