...
📖 **[Detailed Setup Guides](#-documentation)**
...
|----------|-------------|--------|
| [QUICKSTART.md](QUICKSTART.md) | Installation & first run | Setup, basic usage |
| [docs/SECURITY_SETUP.md](docs/SECURITY_SETUP.md) | Environment & API keys | Security, credentials |
| [docs/DATABASE_FAQ.md](docs/DATABASE_FAQ.md) | Database usage & FAQ | ChromaDB, knowledge base |
...
| Document | Description | Topics |
|----------|-------------|--------|
| [MAINTAINER_GUIDE.md](MAINTAINER_GUIDE.md) | Maintenance & updates | Database sync, deployment |
...
- **YouTube Integration**: OAuth setup, chat polling, owner detection
...
### Inspiration
Thanks to the VTuber community for inspiration and the open-source community for making projects like this possible.
...
| TTS not working | Verify API keys, check fallback configuration |
